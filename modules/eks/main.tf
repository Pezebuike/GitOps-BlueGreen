...
-----------------------
${join("\n", [for name, ng in module.eks.eks_managed_node_groups : "Node Group: ${name}, Status: ${ng.status}"])}
...
Cluster Addons:
--------------
${join("\n", [for name, addon in module.eks.cluster_addons : "Addon: ${name}, Version: ${addon.addon_version}"])}
